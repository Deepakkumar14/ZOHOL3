...
public class UserInterface {
    ...
    public void login() {
                        ...
                        if (choice == 1) {
                            ...
                            if (output.equals("true")) {
                                if (temp++ == 0) {
                                    ...
                                    String out = logic.adminPasswordChanger(newPassword, mail);
        ...
        private void adminUserInterface (String mail){
            ...
            switch (choice) {
                case 1: {
                    ArrayList<Products> stock=logic.getStock();
                    if(stock.size()>=1) {
                        for (Products model : stock) {
                                ...
                                if (choice == 1) {
                                    ...
                                    input.nextLine();
                                    String output = logic.setStockCount(model.getModel(), stocks);
                                    System.out.println(output);
                                }
                        }
                    }else
                        System.out.println("All products have stocks greater than 10");
                    adminUserInterface(mail);
                    break;
                }
                case 2: {
...
//                }
                    ...
                    String output = logic.adminPasswordChanger(newPassword, mail);
        ...
        switch (choice){
            case 1: {
                ...
                if (choice == 1)
                    ...
                    if (list != null) {
                        ...
                        System.out.println("No product added to the cart....Choose any product");
                    customerUserInterface(mail);
                    break;
                }
            }
            case 2:{
                ...
                if(cart.size()>=1) {
                    ...
                    System.out.println("No invoice present");
                customerUserInterface(mail);
                break;
            }
            case 3:{
